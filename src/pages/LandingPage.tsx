      ...
      <div className="container mx-auto flex items-center justify-between px-5 py-4">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-600">
          ...
          <div className="flex items-center gap-4 ml-2">
            ...
            <ButtonPrimary to="/register" className="px-6 py-2.5 text-sm" icon={<Rocket className="h-4 w-4" />}>
              Coba Sekarang
            </ButtonPrimary>
          </div>
        </div>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white border-t border-gray-200 px-5 py-4 space-y-4">
          ...
          <div className="pt-2 border-t border-gray-100 flex flex-col gap-3">
            ...
            <ButtonPrimary to="/register" className="w-full py-3 text-sm" icon={<Rocket className="h-4 w-4" />}>
              Coba Sekarang
            </ButtonPrimary>
          </div>
        </div>
